        ...
        if (isset($_POST["_id"])) {
            if ($_POST["_method"] === "DELETE") {
                if ($role == 'owner') {
                    ...
                    $feedback = "You're not able to delete users!";
                }
                ...
                if ($role == 'assistant' || $role == 'owner') {
                    ...
                    $feedback = "You're not able to De- / Activate users!";
                }
            }
        }
    }
...
<body>
    ...
    <div class="doxes">
        ...
        <div class="ohADox">
            <h3>Information:</h3>
            <p>deactivating a user will hide the user for everyone</p>
            <p>he'll be also unable to use any of our services</p>
            <p>that means the user is visible in the ACP ONLY!</p>
        </div>
        <?php
            ...
            if ($result->num_rows > 0) {
                foreach ($result as $row) {
                    ...
                    echo '<p><span class="bold">DATA:</span></p>';
                    echo '<p><span class="bold">Role: </span>'.$row['role'].'</p>';
                    echo '<p><span class="bold">Creation: </span>'.$row['created'].'</p>';
                    ...
                    if ($row['activated']) {
                        if ($role == 'assistant') {
                            if ($row['role'] !== "assistant" && $row['role'] !== "owner") {
